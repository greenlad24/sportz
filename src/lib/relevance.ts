...
const KEYWORDS: Record<Category, { term: string; score: number }[]> = {
  ...
  nba: [
    { term: "nba", score: 6 },
    { term: "אן.בי.איי", score: 6 },
    { term: "פלייאוף", score: 3 },
    { term: "playoff", score: 3 },
    { term: "finals", score: 4 },
    { term: "גמר ה-nba", score: 5 },
    { term: "mvp", score: 3 },
    { term: "lebron", score: 5 },
    { term: "לברון", score: 5 },
    { term: "curry", score: 5 },
    ...
    { term: "durant", score: 5 },
    { term: "דורנט", score: 5 },
    { term: "giannis", score: 5 },
    { term: "אנטטוקומפו", score: 5 },
    { term: "jokic", score: 5 },
    { term: "יוקיץ", score: 5 },
    { term: "doncic", score: 5 },
    { term: "דונצ'יץ", score: 5 },
    { term: "lakers", score: 4 },
    { term: "לייקרס", score: 4 },
    { term: "celtics", score: 4 },
    { term: "סלטיקס", score: 4 },
    { term: "warriors", score: 4 },
  ],
  israeli_basketball: [
