...
אורך, מבנה וקריאוּת:
- האורך נגזר מהחומר, לא להפך. כתבה עשירה בעובדות: עד ~700 מילים. כתבה שמבוססת על פריט דליל (מעט עובדות, בלי שמות/מספרים): 200-400 מילים - חדה, צפופה, בלי מתיחה. עדיף כתבה קצרה וחזקה מכתבה ארוכה ומדוללת. לעולם אל תנפח כדי להגיע לאורך.
