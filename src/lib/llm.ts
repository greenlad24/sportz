...
אורך, מבנה וקריאוּת:
- כל כתבה: 600-800 מילים, כתבה שלמה ומספקת (לא תקציר ולא "סטאב"). מוכנה לפרסום כפי שהיא.
...
5. כותרות ברמת עיתון: headline חד, מדויק ומסקרן - כמו באתר ספורט מוביל. עברית תקנית, בלי תרגומית ובלי קליק-בייט זול. subtitle מוסיף מידע ולא חוזר על הכותרת.
  ...
  "articles": [
    {
      ...
      "body": "גוף הכתבה (600-800 מילים). פסקאות קצרות מופרדות בשורה ריקה. כותרות-משנה ב-## . 1-3 קישורים פנימיים [טקסט](/article/SLUG).",
